...
public class Kwic {
     ...
     *                      matching any of the provided search criteria.
	 */
	public static ArrayList<Url> doSearch(String searchTerms, int startRow, int numResults, int sortOrder) {
            return new UrlConnectionService().getResults(searchTerms, startRow, numResults, sortOrder);
	}
